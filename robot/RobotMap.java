...
public class RobotMap {
  ...
  public static final int GRAB_MOTOR_ID = 2;   //DIO input???
  ...
  public static final double GRAB_SPEED = 0.5; // Speed of the motor
  public static final double GRAB_REVOLUTION = 0.75; // Currently time motor is moving, will eventually be number of revolutions of motor (~43)
